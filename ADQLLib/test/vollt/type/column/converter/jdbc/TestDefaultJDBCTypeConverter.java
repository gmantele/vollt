 ...
 * @version (02/2026)
 */
public class TestDefaultJDBCTypeConverter {
    ...
    public void toColumnType_ShouldSucceed_WhenSimpleVOTableTypes() {
         ...
         */
        // Given:
        final JDBCType[] supportedJDBCTypes = new JDBCType[]{
                new JDBCType(java.sql.JDBCType.BOOLEAN.getName()                , Types.BOOLEAN                , null, null),
                new JDBCType(java.sql.JDBCType.BIT.getName()                    , Types.BIT                    , null, null),
                new JDBCType(java.sql.JDBCType.BINARY.getName()                 , Types.BINARY                 , 1   , null),
                new JDBCType(java.sql.JDBCType.SMALLINT.getName()               , Types.SMALLINT               , null, null),
                new JDBCType(java.sql.JDBCType.TINYINT.getName()                , Types.TINYINT                , null, null),
                new JDBCType(java.sql.JDBCType.INTEGER.getName()                , Types.INTEGER                , null, null),
                new JDBCType(java.sql.JDBCType.BIGINT.getName()                 , Types.BIGINT                 , null, null),
                new JDBCType(java.sql.JDBCType.ROWID.getName()                  , Types.ROWID                  , null, null),
                new JDBCType(java.sql.JDBCType.CHAR.getName()                   , Types.CHAR                   , 1   , null),
                new JDBCType(java.sql.JDBCType.NCHAR.getName()                  , Types.NCHAR                  , 1   , null),
                new JDBCType(java.sql.JDBCType.FLOAT.getName()                  , Types.FLOAT                  , null, null),
                new JDBCType(java.sql.JDBCType.REAL.getName()                   , Types.REAL                   , null, null),
                new JDBCType(java.sql.JDBCType.DOUBLE.getName()                 , Types.DOUBLE                 , null, null),
                new JDBCType(java.sql.JDBCType.DECIMAL.getName()                , Types.DECIMAL                , null, null),
                new JDBCType(java.sql.JDBCType.NUMERIC.getName()                , Types.NUMERIC                , null, null),
                new JDBCType(java.sql.JDBCType.TIMESTAMP.getName()              , Types.TIMESTAMP              , null, null),
                new JDBCType(java.sql.JDBCType.DATE.getName()                   , Types.DATE                   , null, null),
                new JDBCType(java.sql.JDBCType.TIME.getName()                   , Types.TIME                   , null, null),
                new JDBCType(java.sql.JDBCType.TIME_WITH_TIMEZONE.getName()     , Types.TIME_WITH_TIMEZONE     , null, null),
                new JDBCType(java.sql.JDBCType.TIMESTAMP_WITH_TIMEZONE.getName(), Types.TIMESTAMP_WITH_TIMEZONE, null, null)
        };
        ...
        final DefaultJDBCTypeConverter converter = new DefaultJDBCTypeConverter();
    ...
    public void fromColumnType()
    {
        ...
        final JDBCType[] expectedJDBCTypes = new JDBCType[]{
                new JDBCType(java.sql.JDBCType.BOOLEAN.getName()                , Types.BOOLEAN                , null, null),
                new JDBCType(java.sql.JDBCType.BIT.getName()                    , Types.BIT                    , null, null),
                new JDBCType(java.sql.JDBCType.BINARY.getName()                 , Types.BINARY                 , 1   , null),
                new JDBCType(java.sql.JDBCType.SMALLINT.getName()               , Types.SMALLINT               , null, null),
                ...
                new JDBCType(java.sql.JDBCType.FLOAT.getName()                  , Types.FLOAT                  , null, null),
                new JDBCType(java.sql.JDBCType.DOUBLE.getName()                 , Types.DOUBLE                 , null, null),
                new JDBCType(java.sql.JDBCType.VARCHAR.getName()                , Types.VARCHAR                , null, null),
                new JDBCType(java.sql.JDBCType.VARCHAR.getName()                , Types.VARCHAR                , null, null),
                new JDBCType(java.sql.JDBCType.TIMESTAMP.getName()              , Types.TIMESTAMP              , null, null),
                new JDBCType(java.sql.JDBCType.VARCHAR.getName()                , Types.VARCHAR                , null, null),
                new JDBCType(java.sql.JDBCType.VARCHAR.getName()                , Types.VARCHAR                , null, null),
        ...
        {
            // When:
            final JDBCType returnedType = converter.fromColumnType(supportedColumnTypes[i]);

            // Then:
            final JDBCType expectedType = expectedJDBCTypes[i];
