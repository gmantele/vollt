...
public class ADQLColumn implements ADQLOperand, UnknownType {
	...
	/** The corresponding column in the "database". By default, this field is
	 * automatically filled by {@link adql.db.DBChecker}. */
	...
	/* ************ */
	/**
	 * Builds a Column with the complete reference to a column
	 * ({schema(s)}.{table}.{column}).
	 *
	...
	/**
	 * Builds a column with the given column name, table name, schema name and
	 * catalog name.
	 *
	...
	/**
	 * Sets the position at which this {@link ADQLColumn} has been found in the
	...
	/**
	 * Gets the full name of this column
	...
	/**
	 * Updates the whole Column according to the given column reference
	 * ({catalog}.{schema}.{table}.{column}).
	 *
	 * @param columnRef	The complete column reference
	 *                 	({catalog}.{schema}.{table}.{column}).
	 */
	...
	/**
	 * Indicates whether the specified field (catalog, schema, table or column)
	...
	/**
	 * Indicates whether all fields (catalog, schema, table and column) are case
	 * sensitive.
	 *
